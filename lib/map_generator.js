...
MapGenerator.createMercator = function( req ) {
...
MapGenerator.finishMap = function( req, res, map, layer, features, callback ) {
  ...
  if( req.params.format == "grid.json" ) {
    ...
    var im = new mapnik.Grid( global.config.tileSize, global.config.tileSize, { key: "id" } );
    ...
    var im = new mapnik.Image( global.config.tileSize, global.config.tileSize );
