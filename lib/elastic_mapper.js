...
ElasticMapper.passthroughFunction = function( req, callback ) {
  callback( null, req );
};
...
ElasticMapper.server = function( config ) {
  ...
  global.config.beforePrepareQuery =
    global.config.beforePrepareQuery || ElasticMapper.passthroughFunction;
  global.config.prepareQuery =
    global.config.prepareQuery || ElasticMapper.prepareQuery;
  global.config.prepareStyle =
    global.config.prepareStyle || ElasticMapper.passthroughFunction;
